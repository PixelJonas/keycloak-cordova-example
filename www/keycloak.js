...
(function( window, undefined ) {
  ...
  var Keycloak = function (config) {
    ...
    kc.createLoginUrl = function(options) {
      ...
      console.log('createLoginURL' + JSON.stringify(url));
    ...
    function loadAdapter(type) {
      ...
      if (type == 'cordova-native') {
        ...
        return {
          login: function(options) {
            console.log('KeyCloak.js: Login called');
            console.log('KeyCloak.js: universalLinks: ' + JSON.stringify(window.cordova.plugins.browsertab));
            var promise = createPromise();
            var loginUrl = kc.createLoginUrl(options);
            console.log('KeyCloak.js: loginUrl: ' + JSON.stringify(loginUrl));
            universalLinks.subscribe('login', function(event) {
              console.log('KeyCloak.js: UniversalLinks login');
              universalLinks.unsubscribe('login');
              window.cordova.plugins.browsertab.close();
              var oauth = parseCallback(event.url);
              processCallback(oauth, promise);
            });
            console.log('Opening browsertab');
